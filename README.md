...
* get all rides - GET [/ride](http://localhost:8081/ride) to get a list of all the rides
* get specific ride - GET [/ride/${id}](http://localhost:8081/ride/1) to get a specific ride
* create ride - POST JSON to [/ride](http://localhost:8081/ride) to create a new ride 
